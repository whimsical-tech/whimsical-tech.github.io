...
P.S.: [この記事はQiitaでもご覧いただけます。](https://qiita.com/frontendpro/items/feefa08f98293e2286e4)
...
![現在のディレクトリ構造は以下のようになっています。](../../blog/directory.png "現在のディレクトリ構造は以下のようになっています。")
...
![UIに実装された言語スイッチャー](../../blog/languageSwitcher.png "UIに実装された言語スイッチャー")
...
![このページは英語で表示されるべきですが、読み込み時に一時的に日本語のテキストが表示される可能性があります。](../../blog/badUi.png "")
...
![読み込み状態を実装すると、代わりにコンポーネントのスケルトンが表示され、その後、期待される文字列が表示されます。](../../blog/loading.png "")
